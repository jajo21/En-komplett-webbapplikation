...
**Webbläsare där du behöver navigera in på https://localhost:5006 för att testa klientgränssnittet.** Vill du endast kontrollera API-åtkomstpunkterna så navigera in på **https://localhost:5006/api/rovers för alla rovers eller https://localhost:5006/api/rovers/{roverId} för att få en rover beroende på id**
